...
//I can now stretch it's class definition across multiples files - 
//when I build, all the content from all files is stitched together
public partial class Catalog //
{
    ...
    //COllection of all authors in my coatalog
    ...
    //This syntax where the => is the "expression body syntax", if a method only runs a single expression (one line)
    //then wecan use thiis as a shorthand
